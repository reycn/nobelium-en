...
var Text = function (_a) {
    ...
    var _b = (0, context_1.useNotionContext)(), components = _b.components, recordMap = _b.recordMap, mapPageUrl = _b.mapPageUrl, mapImageUrl = _b.mapImageUrl, rootDomain = _b.rootDomain;
        ...
        var formatted = decorations.reduce(function (element, decorator) {
            ...
            switch (decorator[0]) {
                ...
                case 'a': {
                    ...
                    var id = (0, notion_utils_1.parsePageId)(pathname, { uuid: true });
                    if ((v[0] === '/' || v.includes(rootDomain)) && id) {
                        var href = v.includes(rootDomain)
                            ? v
                            : "" + mapPageUrl(id) + (0, utils_1.getHashFragmentValue)(v);
                        return (react_1["default"].createElement(components.pageLink, __assign({ className: 'notion-link', href: href }, linkProps), element));
                    }
                    else {
                ...
                case 'd': {
                    ...
                    if (type === 'date') {
                        ...
                        return (0, utils_1.formatDate)(startDate);
                    }
                    else if (type === 'daterange') {
                        // Example: Jul 31, 2010 → Jul 31, 2020
                        var startDate = v.start_date;
                        var endDate = v.end_date;
                        return (0, utils_1.formatDate)(startDate) + " \u2192 " + (0, utils_1.formatDate)(endDate);
                    }
                    else {
                        return element;
                    }
