...
var LazyImage = function (_a) {
    ...
    var _e = (0, context_1.useNotionContext)(), recordMap = _e.recordMap, zoom = _e.zoom, previewImages = _e.previewImages, customImages = _e.customImages, components = _e.components;
    ...
    if (previewImage) {
        ...
        return (react_1["default"].createElement(react_lazy_images_1.LazyImageFull, __assign({ src: src }, rest), function (_a) {
            ...
            return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('lazy-image-wrapper', isLoaded && 'lazy-image-loaded', className), style: wrapperStyle },
                ...
                customImages ? (react_1["default"].createElement(components.image, { src: src, alt: alt, className: 'lazy-image-real', style: __assign(__assign({}, style), imgStyle), width: previewImage.originalWidth, height: previewImage.originalHeight, loading: 'lazy', decoding: 'async', ref: attachZoomRef, onLoad: function (e) {
        ...
        if (customImages) {
            return (react_1["default"].createElement(components.image, { src: src, alt: alt, className: className, style: style, loading: 'lazy', decoding: 'async', width: null, height: height || null, ref: attachZoomRef, onLoad: function (e) {
                    if (e.target.srcset && zoomable) {
                        if (zoomRef.current) {
                            ;
                            zoomRef.current.attach(e.target);
