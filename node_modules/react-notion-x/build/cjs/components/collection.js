...
var Collection = function (_a) {
    ...
    var _f = (0, context_1.useNotionContext)(), recordMap = _f.recordMap, showCollectionViewDropdown = _f.showCollectionViewDropdown;
    var collectionId = block.collection_id, viewIds = block.view_ids;
    var _g = (0, react_use_1.useLocalStorage)(block.id, {
    ...
    var parentPage = (0, notion_utils_1.getBlockParentPage)(block, recordMap);
    ...
    var title = (0, notion_utils_1.getTextContent)(collection.name).trim();
    if (collection.icon) {
        block.format = __assign(__assign({}, block.format), { page_icon: collection.icon });
    }
    return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-collection', className) },
...
var CollectionViewColumnDesc = function (_a) {
    ...
    return (react_1["default"].createElement("div", __assign({ className: (0, utils_1.cs)('notion-collection-view-type', className) }, rest),
