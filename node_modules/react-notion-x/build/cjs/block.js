...
var Block = function (props) {
    ...
    var _17 = (0, context_1.useNotionContext)(), components = _17.components, fullPage = _17.fullPage, darkMode = _17.darkMode, recordMap = _17.recordMap, mapPageUrl = _17.mapPageUrl, mapImageUrl = _17.mapImageUrl, showTableOfContents = _17.showTableOfContents, minTableOfContentsItems = _17.minTableOfContentsItems, defaultPageIcon = _17.defaultPageIcon, defaultPageCover = _17.defaultPageCover, defaultPageCoverPosition = _17.defaultPageCoverPosition;
    ...
    switch (block.type) {
        ...
        case 'page':
            if (level === 0) {
                var _18 = block.format || {}, _19 = _18.page_icon, page_icon = _19 === void 0 ? defaultPageIcon : _19, _20 = _18.page_cover, page_cover = _20 === void 0 ? defaultPageCover : _20, _21 = _18.page_cover_position, page_cover_position = _21 === void 0 ? defaultPageCoverPosition : _21, page_full_width = _18.page_full_width, page_small_text = _18.page_small_text;
                if (fullPage) {
                    ...
                    var _22 = react_1["default"].useState(null), activeSection_1 = _22[0], setActiveSection_1 = _22[1];
                    var throttleMs = 100;
                    ...
                    return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion', 'notion-app', darkMode ? 'dark-mode' : 'light-mode', blockId, className) },
                        ...
                        react_1["default"].createElement("div", { className: 'notion-frame' },
                            !disableHeader && react_1["default"].createElement(header_1.Header, { header: header }),
        ...
        case 'sub_sub_header': {
            ...
            var innerHeader = (react_1["default"].createElement("span", null,
                ...
                !((_f = block.format) === null || _f === void 0 ? void 0 : _f.toggleable) && (react_1["default"].createElement("a", { className: 'notion-hash-link', href: "#" + id, title: title_1 },
            ...
            var headerBlock = (react_1["default"].createElement("h4", { className: classNameStr, "data-id": id }, innerHeader));
            //page title takes the h1 so all header blocks are greater
            if (isH1) {
                headerBlock = (react_1["default"].createElement("h2", { className: classNameStr, "data-id": id }, innerHeader));
            }
            else if (isH2) {
                headerBlock = (react_1["default"].createElement("h3", { className: classNameStr, "data-id": id }, innerHeader));
            }
            if ((_g = block.format) === null || _g === void 0 ? void 0 : _g.toggleable) {
                return (react_1["default"].createElement("details", { className: (0, utils_1.cs)('notion-toggle', blockId) },
                    react_1["default"].createElement("summary", null, headerBlock),
        ...
        case 'text':
            ...
            return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-text', blockColor && "notion-" + blockColor, blockId) },
                ((_k = block.properties) === null || _k === void 0 ? void 0 : _k.title) && (react_1["default"].createElement(text_1.Text, { value: block.properties.title, block: block })),
        ...
        case 'code': {
            if (block.properties.title) {
                var content = (0, notion_utils_1.getBlockTitle)(block, recordMap);
        ...
        case 'quote': {
            if (!block.properties)
                return null;
            var blockColor_3 = (_t = block.format) === null || _t === void 0 ? void 0 : _t.block_color;
        ...
        case 'callout':
            if (components.callout) {
                ...
                return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-callout', ((_u = block.format) === null || _u === void 0 ? void 0 : _u.block_color) &&
                    ...
                    react_1["default"].createElement("div", { className: 'notion-callout-text' },
                        react_1["default"].createElement(text_1.Text, { value: (_w = block.properties) === null || _w === void 0 ? void 0 : _w.title, block: block }),
                        children)));
            }
        case 'bookmark':
            if (!block.properties)
                return null;
            var title = (0, notion_utils_1.getTextContent)((_x = block.properties) === null || _x === void 0 ? void 0 : _x.title);
            if (!title) {
                title = (0, notion_utils_1.getTextContent)((_y = block.properties) === null || _y === void 0 ? void 0 : _y.link);
            }
            if (title) {
            ...
            return (react_1["default"].createElement("div", { className: 'notion-row' },
                react_1["default"].createElement(components.link, { target: '_blank', rel: 'noopener noreferrer', className: (0, utils_1.cs)('notion-bookmark', ((_z = block.format) === null || _z === void 0 ? void 0 : _z.block_color) && "notion-" + block.format.block_color, blockId), href: block.properties.link[0][0] },
                    react_1["default"].createElement("div", null,
                        ...
                        ((_0 = block.properties) === null || _0 === void 0 ? void 0 : _0.description) && (react_1["default"].createElement("div", { className: 'notion-bookmark-description' },
                            react_1["default"].createElement(text_1.Text, { value: (_1 = block.properties) === null || _1 === void 0 ? void 0 : _1.description, block: block }))),
                        react_1["default"].createElement("div", { className: 'notion-bookmark-link' },
                            ((_2 = block.format) === null || _2 === void 0 ? void 0 : _2.bookmark_icon) && (react_1["default"].createElement(graceful_image_1.GracefulImage, { src: (_3 = block.format) === null || _3 === void 0 ? void 0 : _3.bookmark_icon, alt: title, loading: 'lazy' })),
                            react_1["default"].createElement("div", null,
                                react_1["default"].createElement(text_1.Text, { value: (_4 = block.properties) === null || _4 === void 0 ? void 0 : _4.link, block: block })))),
                    ((_5 = block.format) === null || _5 === void 0 ? void 0 : _5.bookmark_cover) && (react_1["default"].createElement("div", { className: 'notion-bookmark-image' },
                        react_1["default"].createElement(graceful_image_1.GracefulImage, { src: (_6 = block.format) === null || _6 === void 0 ? void 0 : _6.bookmark_cover, alt: (0, notion_utils_1.getTextContent)((_7 = block.properties) === null || _7 === void 0 ? void 0 : _7.title), loading: 'lazy' }))))));
        case 'toggle':
            return (react_1["default"].createElement("details", { className: (0, utils_1.cs)('notion-toggle', blockId) },
                react_1["default"].createElement("summary", null,
                    react_1["default"].createElement(text_1.Text, { value: (_8 = block.properties) === null || _8 === void 0 ? void 0 : _8.title, block: block })),
                react_1["default"].createElement("div", null, children)));
        case 'table_of_contents': {
            ...
            if (!page)
                return null;
            var toc = (0, notion_utils_1.getPageTableOfContents)(page, recordMap);
            var blockColor_4 = (_9 = block.format) === null || _9 === void 0 ? void 0 : _9.block_color;
            ...
            return (react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-to-do', blockId) },
                react_1["default"].createElement("div", { className: 'notion-to-do-item' },
                    ...
                    react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-to-do-body', isChecked && "notion-to-do-checked") },
                        react_1["default"].createElement(text_1.Text, { value: (_13 = block.properties) === null || _13 === void 0 ? void 0 : _13.title, block: block }))),
        ...
        case 'alias':
            ...
            return (react_1["default"].createElement(components.pageLink, { className: (0, utils_1.cs)('notion-page-link', blockPointerId), href: mapPageUrl(blockPointerId) },
                react_1["default"].createElement(page_title_1.PageTitle, { block: linkedBlock })));
        case 'table':
            return (react_1["default"].createElement("table", { className: (0, utils_1.cs)('notion-simple-table', blockId) },
        ...
        case 'table_row':
            ...
            return (react_1["default"].createElement("tr", { className: (0, utils_1.cs)('notion-simple-table-row', blockId) }, order.map(function (column) {
                var _a, _b;
                var color = formatMap_1 && formatMap_1[column] ? (_a = formatMap_1[column]) === null || _a === void 0 ? void 0 : _a.color : null;
                return (react_1["default"].createElement("td", { key: column, className: color ? "notion-" + color : '', style: {
                        width: formatMap_1 && formatMap_1[column] && ((_b = formatMap_1[column]) === null || _b === void 0 ? void 0 : _b.width)
                            ? formatMap_1[column].width
                            : 120
                    } },
                    react_1["default"].createElement("div", { className: 'notion-simple-table-cell' },
                        react_1["default"].createElement(text_1.Text, { value: block.properties ? block.properties[column] : [['ㅤ']], block: block }))));
            })));
        default:
