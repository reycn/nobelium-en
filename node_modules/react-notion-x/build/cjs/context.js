...
var DefaultImage = function (props) { return (react_1["default"].createElement(lazy_image_1.LazyImage, __assign({}, props))); };
...
var defaultNotionContext = {
    ...
    mapPageUrl: (0, utils_1.defaultMapPageUrl)(),
...
var NotionContextProvider = function (_a) {
    ...
    return (react_1["default"].createElement(ctx.Provider, { value: __assign(__assign(__assign({}, defaultNotionContext), rest), { rootPageId: rootPageId, mapPageUrl: mapPageUrl !== null && mapPageUrl !== void 0 ? mapPageUrl : (0, utils_1.defaultMapPageUrl)(rootPageId), mapImageUrl: mapImageUrl !== null && mapImageUrl !== void 0 ? mapImageUrl : utils_1.defaultMapImageUrl, components: __assign(__assign({}, defaultComponents), themeComponents) }) }, children));
};
