    ...
    switch (block.type) {
        ...
        case 'page':
            if (level === 0) {
                ...
                if (fullPage) {
                    ...
                    var _22 = React.useState(null), activeSection_1 = _22[0], setActiveSection_1 = _22[1];
                    var throttleMs = 100;
        ...
        case 'sub_sub_header': {
            ...
            var innerHeader = (React.createElement("span", null,
                ...
                !((_f = block.format) === null || _f === void 0 ? void 0 : _f.toggleable) && (React.createElement("a", { className: 'notion-hash-link', href: "#" + id, title: title_1 },
