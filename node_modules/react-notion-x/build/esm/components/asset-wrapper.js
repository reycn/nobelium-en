...
export var AssetWrapper = function (_a) {
    ...
    if (isURL) {
        ...
        var id = parsePageId(caption, { uuid: true });
        var isPage = caption.charAt(0) === '/' && id;
        return (React.createElement(components.pageLink, { style: { width: '100%' }, href: isPage ? mapPageUrl(id) : caption, target: extractHostname(caption) != rootDomain && !caption.startsWith("/") ? "blank_" : null }, figure));
    }
