...
export var LazyImage = function (_a) {
    ...
    var _e = useNotionContext(), recordMap = _e.recordMap, zoom = _e.zoom, previewImages = _e.previewImages, customImages = _e.customImages, components = _e.components;
    ...
    if (previewImage) {
        ...
        return (React.createElement(LazyImageFull, __assign({ src: src }, rest), function (_a) {
            ...
            return (React.createElement("div", { className: cs('lazy-image-wrapper', isLoaded && 'lazy-image-loaded', className), style: wrapperStyle },
                ...
                customImages ? (React.createElement(components.image, { src: src, alt: alt, className: 'lazy-image-real', style: __assign(__assign({}, style), imgStyle), width: previewImage.originalWidth, height: previewImage.originalHeight, loading: 'lazy', decoding: 'async', ref: attachZoomRef, onLoad: function (e) {
        ...
        if (customImages) {
            return (React.createElement(components.image, { src: src, alt: alt, className: className, style: style, loading: 'lazy', decoding: 'async', width: null, height: height || null, ref: attachZoomRef, onLoad: function (e) {
                    if (e.target.srcset && zoomable) {
                        if (zoomRef.current) {
                            ;
                            zoomRef.current.attach(e.target);
