        ...
        if (data ||
            ...
            switch (schema.type) {
                ...
                case 'number':
                    ...
                    break;
                case 'created_time':
                    content = format(new Date(block === null || block === void 0 ? void 0 : block.created_time), 'MMM d, YYY hh:mm aa');
                    break;
                case 'last_edited_time':
                    content = format(new Date(block === null || block === void 0 ? void 0 : block.last_edited_time), 'MMM d, YYY hh:mm aa');
                    break;
                case 'created_by':
