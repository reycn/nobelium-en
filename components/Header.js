...
const NavBar = () => {
  ...
  const links = [
    ...
    { id: 3, name: "Gallery", to: 'https://photo.rongxin.me/', show: true },
    { id: 4, name: "Research", to: 'https://pubs.rongxin.me/', show: true }
    // { id: 4, name: "CV", to: 'https://rongxin.me/cv', show: true },
